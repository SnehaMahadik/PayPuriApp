...
import com.mastek.paypuriapp.adapters.OrderDetailsAdapter;
import com.mastek.paypuriapp.models.OrderItemDetail;
import com.mastek.paypuriapp.utils.CircularImageview;
...
public class OrderDetailsFragment extends Fragment {
    ...
    private void prepareListData() {
        ...
        // Adding headers
        for (int i = 0; i < OrderListFragment.getAllOrdersResponse.getOrders().get(position).getOrderItemDetails().size(); i++) {
            if (!listDataHeader.contains(OrderListFragment.getAllOrdersResponse.getOrders().get(position).getOrderItemDetails().get(i).getPacketId())) {
                listDataHeader.add(OrderListFragment.getAllOrdersResponse.getOrders().get(position).getOrderItemDetails().get(i).getPacketId());
...
//Add Childs
        ...
        for (int i = 0; i < listDataHeader.size(); i++) {
            ...
            for (OrderItemDetail a : OrderListFragment.getAllOrdersResponse.getOrders().get(position).getOrderItemDetails()) {
