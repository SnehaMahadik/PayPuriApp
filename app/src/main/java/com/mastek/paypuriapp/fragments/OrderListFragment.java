...
import com.mastek.paypuriapp.adapters.OrderListAdapter;
import com.mastek.paypuriapp.interfaces.InboxFragmentListener;
import com.mastek.paypuriapp.interfaces.OrderListClickListener;
import com.mastek.paypuriapp.models.GetAllOrdersResponse;
import com.mastek.paypuriapp.models.Order;
...
public class OrderListFragment extends Fragment implements Response.Listener, Response.ErrorListener, OrderListClickListener {
    ...
    public static GetAllOrdersResponse getAllOrdersResponse;
    ...
    public void onResponse(Object response) {
        if(response  instanceof GetAllOrdersResponse){
            getAllOrdersResponse=new GetAllOrdersResponse();
